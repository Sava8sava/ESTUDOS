...
class Menu:
    ...
    # O(n^2)
    y_bubble = [160.77, 658.62, 7037.143, 31281.251, 50000]  # O último teste de bubble demorou mais de 12 horas (individualmente), e não terminou; 50000 é uma aproximação e o valor real deve superar isso.
    y_selec = [52.631, 287.513, 3603.861, 11720.246, 33665.1167]
